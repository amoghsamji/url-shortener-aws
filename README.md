...
http://a-url-shortener.s3-website.eu-north-1.amazonaws.com/
...
Built this project to gain practical experience with AWS serverless architecture, including Lambda, API Gateway, DynamoDB, S3, IAM, CORS, and DynamoDB TTL.
